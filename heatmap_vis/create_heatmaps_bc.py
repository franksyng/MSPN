...
from vis_utils.heatmap_utils import initialize_wsi, drawHeatmap, compute_from_patches_trans, compute_from_patches2
...
if __name__ == '__main__':
    ...
    for i in range(len(process_stack)):
        ...
        if heatmap_args.calc_heatmap:
            ...
            compute_from_patches2(wsi_object=wsi_object, model=model, features=features, coords=coords, clam_pred=None, attn_save_path=save_path)
